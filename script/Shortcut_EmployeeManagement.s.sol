...
contract ShortcutEmployeeManagement is Script, HelperScript {
    ...
    function _checkOrganizationBalance() internal {
    ...
    function _checkEmployeeStatus() internal {
    ...
    function addCustomEmployee(
        ...
        Organization(targetOrganization).addEmployee(
            ...
            _employee,
            _salary,
            _startNow ? block.timestamp : block.timestamp + 30 days,
            _startNow
        );
