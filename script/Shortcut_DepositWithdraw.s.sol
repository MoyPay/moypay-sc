...
contract ShortcutDepositWithdraw is Script, HelperScript {
    ...
    function _checkInitialBalances() internal view {
    ...
    function _simulateTimeAndAccrual() internal {
        ...
        uint256 availableSalary = Organization(targetOrganization)._currentSalary(testEmployee);
        console.log(
            "Employee available salary after 15 days:",
            availableSalary / 10 ** IERC20Metadata(mockUSDC).decimals(),
            "USDC"
        );
        console.log("");
    }
    ...
    function _demonstrateWithdrawals() internal {
        ...
        console.log(
            "Employee balance before withdrawal:", empBalanceBefore / 10 ** IERC20Metadata(mockUSDC).decimals(), "USDC"
        );
        ...
        console.log(
            "Employee balance after withdrawal:", empBalanceAfter / 10 ** IERC20Metadata(mockUSDC).decimals(), "USDC"
        );
    ...
    function _demonstrateOwnerWithdrawal() internal {
        ...
        console.log(
            "Organization balance before:", orgBalanceBefore / 10 ** IERC20Metadata(mockUSDC).decimals(), "USDC"
        );
    ...
    function demonstrateWithdrawAll() public {
        ...
        console.log(
            "Employee balance after withdrawAll:", empBalanceAfter / 10 ** IERC20Metadata(mockUSDC).decimals(), "USDC"
        );
        console.log(
            "Remaining salary (should be 0):", remainingSalary / 10 ** IERC20Metadata(mockUSDC).decimals(), "USDC"
        );
